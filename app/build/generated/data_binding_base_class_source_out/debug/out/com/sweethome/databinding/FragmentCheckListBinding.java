...
public final class FragmentCheckListBinding implements ViewBinding {
  ...
  private FragmentCheckListBinding(@NonNull ConstraintLayout rootView, @NonNull TextView emptyText,
  ...
  public static FragmentCheckListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_check_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentCheckListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCheckListBinding((ConstraintLayout) rootView, emptyText, progressBar,
          recyclerView);
    }
