...
public final class FragmentCameraBinding implements ViewBinding {
  ...
  private FragmentCameraBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton cameraCaptureButton, @NonNull PreviewView viewFinder) {
  ...
  public static FragmentCameraBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FloatingActionButton cameraCaptureButton = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentCameraBinding((ConstraintLayout) rootView, cameraCaptureButton,
          viewFinder);
    }
