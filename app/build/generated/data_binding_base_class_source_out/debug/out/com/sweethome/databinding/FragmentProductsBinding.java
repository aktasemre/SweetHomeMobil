...
public final class FragmentProductsBinding implements ViewBinding {
  ...
  private FragmentProductsBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppBarLayout appBarLayout, @NonNull RecyclerView productsRecyclerView,
  ...
  public static FragmentProductsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProductsBinding((ConstraintLayout) rootView, appBarLayout,
          productsRecyclerView, progressBar, toolbar);
    }
