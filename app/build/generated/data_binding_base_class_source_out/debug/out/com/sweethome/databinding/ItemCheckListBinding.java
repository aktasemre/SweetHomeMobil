...
public final class ItemCheckListBinding implements ViewBinding {
  ...
  private ItemCheckListBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView descriptionText, @NonNull ImageView photoImage,
  ...
  public static ItemCheckListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCheckListBinding((MaterialCardView) rootView, descriptionText, photoImage,
          titleText);
    }
